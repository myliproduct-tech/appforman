    ...
    return (
        <div className="fixed inset-0 z-[70] bg-[#1f2933] flex flex-col animate-fade-in overflow-hidden">
            <div className="max-w-md mx-auto w-full h-full flex flex-col bg-[#1f2933]">
                {/* Header */}
                <div className="flex justify-between items-center bg-[#1f2933] px-4 py-6 z-30 border-b border-white/10 shadow-xl shrink-0">
                ...
                <div className="flex-1 overflow-y-auto px-4 pt-4 pb-24 custom-scrollbar">
                    <div className="glass-card p-6 rounded-[2rem] border-white/10 shadow-2xl relative">
