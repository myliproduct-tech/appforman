...
export const Budget: React.FC<BudgetProps> = ({
    ...
    return (
        <div className="space-y-6 pb-20">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#f6c453]/10 via-slate-500/5 to-slate-500/10 border border-[#f6c453]/20 p-6 shadow-lg shadow-[#f6c453]/5">
                ...
                <div className="relative flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-2xl font-black italic uppercase accent-text tracking-tight">
                            Logistika
                        </h2>
