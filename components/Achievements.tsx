            ...
            <div className="max-w-md mx-auto w-full h-full flex flex-col bg-[#1f2933]">
                ...
                <div className="flex justify-between items-center bg-[#1f2933] px-4 py-8 z-30 border-b border-white/5 shadow-xl shrink-0">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-lg xs:text-xl sm:text-2xl font-black italic uppercase text-white tracking-tighter leading-none mb-1">Zeď Slávy</h2>
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[9px] font-mono text-[#f6c453] uppercase">{unlockedCount}/{totalCount}</span>
                            </div>
                        </div>
                    </div>
                    <button
                ...
                {/* Grid */}
                <div className="flex-1 overflow-y-auto px-6 pt-6 scrollbar-hide pb-32">
