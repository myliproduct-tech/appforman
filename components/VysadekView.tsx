...
export const VysadekView: React.FC<VysadekViewProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-[#0f172a] text-white flex flex-col animate-fade-in overflow-hidden">
            {/* Fixed Top Section (Header + Navigation) */}
            <div className="shrink-0 z-30 shadow-2xl">
                {/* Krizová Hlavička */}
                <header className="p-6 bg-rose-600 flex justify-between items-center">
                ...
                <div className="px-4 py-4 bg-[#0f172a] border-b border-white/10">
                    <div className="flex p-1 bg-white/5 rounded-[2rem] border-2 border-white/20 shadow-inner backdrop-blur-md">
                        <button
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar">
                <main className="p-4 space-y-6 max-w-xl mx-auto w-full pb-32">
