...
export const MedicalInfoModal: React.FC<MedicalInfoProps> = ({
    ...
    return (
        <>
            ...
            {/* Modal */}
            {showModal && (
                <div className="fixed inset-0 z-[100] bg-[#1f2933] animate-fade-in overflow-y-auto">
                    <div className="w-full max-w-xl mx-auto min-h-full flex flex-col p-4">
                        <div className="flex justify-between items-center mb-6 pt-4 border-b border-white/5 pb-4 shrink-0">
                            <div>
